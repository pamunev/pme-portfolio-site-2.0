      ...
      <div className="content-body">
        <div className="content-flex-container">
          <p className="bio-paragraph">
            ...
            hot city of Austin, Texas. Aside from my proficiency in full-stack
            web development (<b>React, Node.js</b>, etc.), I’ve also developed
            strong skills in collaboration, communication, and quality,
